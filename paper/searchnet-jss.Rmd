...
The $\K$ formulation is currently exercised by six independent research
...
below, and we label each rather than presenting a uniform façade.  The
inclusion criterion is that the application must actually run \pkg{searchnet},
alone or in combination with \pkg{RSiena} or an independent implementation;
projects that share the $\K$ vocabulary but do not call the package are not
listed, however closely related their subject matter.
